...
//引数で渡されたクラスのobserverに自身を追加
void GameObject::AttachObserver(GameObjectObserver* observer)
{
	observers_.push_back(observer);
}

//オブザーバーを削除
void GameObject::DetachObserver(GameObjectObserver* observer)
{
...
void GameObject::NotifyCollision(GameObject* pTarget)
{
	for (auto& observer : observers_)
	{
		observer->OnCollision(this);
	}
}